 ...
 */
public class DefaultBroadcasterFactory implements BroadcasterFactory, Serializable {
    protected transient final ConcurrentLinkedQueue<BroadcasterListener> broadcasterListeners = new ConcurrentLinkedQueue<BroadcasterListener>();

    private static final Logger logger = LoggerFactory.getLogger(DefaultBroadcasterFactory.class);

    protected transient final ConcurrentHashMap<Object, Broadcaster> store = new ConcurrentHashMap<Object, Broadcaster>();

    protected Class<? extends Broadcaster> clazz;

    protected transient BroadcasterLifeCyclePolicy policy =
    ...
    protected transient AtmosphereConfig config;
    protected transient final BroadcasterListener lifeCycleListener = new BroadcasterLifecyclePolicyHandler();
